jQuery Mobile
====================
<a href="https://platform.telerik.com/#appbuilder/clone/https%3A%2F%2Fgithub.com%2FIcenium%2Fsample-jquery-mobile" target="_blank"><img src="http://docs.telerik.com/platform/samples/images/try-in-appbuilder.png" alt="Try in AppBuilder" title="Try in AppBuilder" /></a>  
...
This sample shows you how to use jQuery Mobile to create cross-platform mobile user interface. The app provides dummy login functionality and Google Maps-based geolocation capabilities.
...
Platform | Home | Login | Location
---|---|---|---
All | ![](https://raw.githubusercontent.com/Icenium/sample-jquery-mobile/master/screenshots/home.png) | ![](https://raw.githubusercontent.com/Icenium/sample-jquery-mobile/master/screenshots/login.png) | ![](https://raw.githubusercontent.com/Icenium/sample-jquery-mobile/master/screenshots/location.png)
...
1. Run the clone command for the sample as listed by `appbuilder sample`.
	...
	```bash
	appbuilder sample clone jquery-mobile
	```
...
* The login is a dummy functionality. The login data is never verified on login.
